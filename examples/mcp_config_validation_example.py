...
def main():
    ...
    stdio_template = validator.generate_configuration_template("stdio", "mcp_claude_desktop")
    ...
    http_template = validator.generate_configuration_template("http", "mcp_remote_server")
    ...
    try:
        result = validate_mcp_config_file(standalone_path, strict_mode=True, enable_security_checks=True)
    ...
    print("  python -m graph_of_thoughts.language_models.mcp_protocol validate <config_file>")
    print("  python -m graph_of_thoughts.language_models.mcp_protocol generate-template stdio")
    print("  python -m graph_of_thoughts.language_models.mcp_protocol summary <config_file>")
