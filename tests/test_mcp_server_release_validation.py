...
class MCPServerReleaseValidator:
    ...
    async def test_server_startup(self):
        ...
        try:
            ...
            self.log_test(
                "Server info command",
                result.returncode == 0 and "Graph of Thoughts MCP Server" in result.stdout
            )
    ...
    async def test_error_handling(self):
        ...
        try:
            result = await self.server._generate_thoughts({
                "problem": "Test",
                "num_thoughts": "invalid"  # Should be integer
            })
    ...
    async def test_data_integrity(self):
        ...
        try:
            ...
            if self.server.execution_results:
                ...
                has_operation_id = any("operation_id" in latest_result for latest_result in self.server.execution_results.values())
    ...
    async def test_prompt_templates(self):
        ...
        required_templates = ["analyze-problem", "generate-solutions", "evaluate-options"]
        ...
        for template_name in required_templates:
            ...
            if exists:
                ...
                self.log_test(f"Template '{template_name}' structure", has_required_fields)
