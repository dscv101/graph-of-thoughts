...
class MCPTestRunner:
    ...
    def generate_performance_report(self):
        ...
        print(f"   Average time per test: {self.results.execution_time / max(self.results.total_tests, 1):.3f}s")
...
"""
    ...
    def run(self) -> int:
        ...
        try:
            ...
            # Return exit code
            return 0 if (self.results.failed_tests == 0 and self.results.error_tests == 0) else 1
...
def main():
    ...
    parser.add_argument("--xml-report", action="store_true",
                       help="Generate XML test report for CI")
