...
from graph_of_thoughts.language_models.mcp_transport import MCPTransportError, MCPConnectionError
...
class TestMCPLanguageModel(AsyncTestCase):
    ...
    def test_circuit_breaker_status(self):
        ...
        with patch('graph_of_thoughts.language_models.mcp_transport.create_transport') as mock_create:
            ...
            mock_transport.get_circuit_breaker_state.return_value = MagicMock(value="closed")
