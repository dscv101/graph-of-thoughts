...
from graph_of_thoughts.language_models.mcp_circuit_breaker import (
    ...
    CircuitBreakerOpenError, CircuitBreakerMetrics, create_circuit_breaker_from_config,
...
class TestCircuitBreakerTransportWrapper(AsyncTestCase):
    ...
    def setUp(self):
        ...
        self.circuit_breaker = MCPCircuitBreaker(CircuitBreakerConfig(failure_threshold=2))
        self.wrapper = CircuitBreakerTransportWrapper(self.mock_transport, self.circuit_breaker)
    ...
    async def test_successful_request(self):
        ...
        self.mock_transport.send_request.assert_called_once_with("test_method", {"param": "value"})
