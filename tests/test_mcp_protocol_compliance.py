...
class TestMCPProtocolValidator(unittest.TestCase):
    ...
    def test_validate_transport_invalid_type(self):
        ...
        transport = {"type": "invalid", "command": "test"}
    ...
    def test_validate_sampling_request_missing_messages(self):
        ...
        request = {"maxTokens": 1000, "includeContext": "none"}
    ...
    def test_validate_complete_configuration(self):
        ...
        config = {
            "transport": {"type": "stdio", "command": "test-server", "args": []},
...
class TestMCPProtocolUtilities:
    ...
    def test_create_sampling_request(self):
        ...
        request = create_sampling_request(
            messages=messages, temperature=0.7, max_tokens=1000, include_context="none"
        )
...
class TestMCPLanguageModel:
    ...
    def test_initialization_with_valid_config(self):
        ...
        with patch("builtins.open"), patch("json.load", return_value=config):
            lm = MCPLanguageModel(
                config_path="test_config.json", model_name="test_config", cache=False
            )
    ...
    def test_initialization_with_invalid_config(self):
        ...
        config = {"invalid_config": {"transport": {"type": "invalid"}}}
...
class TestMCPIntegration:
    ...
    async def test_sampling_request_flow(self):
        ...
        with patch("builtins.open"), patch("json.load", return_value=config), patch(
