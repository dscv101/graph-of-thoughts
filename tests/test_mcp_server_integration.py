...
class TestMCPServerEndToEnd(unittest.TestCase):
    ...
    def test_complete_reasoning_workflow(self):
        ...
        async def run_test():
            ...
            problem = "Design an efficient algorithm for finding the shortest path in a graph"
            ...
            scoring_result = await server._score_thoughts({
                "thoughts": thoughts,
                "criteria": "space efficiency and access time"
            })
    ...
    def test_error_recovery_workflow(self):
        ...
        async def run_test():
            ...
            normal_result = await server._generate_thoughts({
                "problem": "Test problem after error",
                "num_thoughts": 2
            })
