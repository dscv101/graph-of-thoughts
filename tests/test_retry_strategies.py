...
from graph_of_thoughts.language_models.mcp_client import (
    RetryConfig, RetryManager, RetryStrategy, BackoffJitterType,
    MCPConnectionError, MCPTimeoutError, MCPServerError, MCPValidationError
)
...
class TestRetryIntegration:
    ...
    async def test_retry_on_connection_error(self):
        ...
        try:
            ...
            with patch('graph_of_thoughts.language_models.mcp_client.create_transport', return_value=mock_transport):
                with patch('graph_of_thoughts.language_models.mcp_client.MCPProtocolValidator'):
    ...
    async def test_no_retry_on_validation_error(self):
        ...
        mock_transport = AsyncMock()
        mock_transport.send_sampling_request.side_effect = MCPValidationError("Invalid request")
